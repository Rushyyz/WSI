    ...
    try:
        ...
        for log_path in logs_paths:
            command += (
                ...
                f'grep -iE "ERROR|SEVERE|FAIL|EXCEPTION|Event" | '
                f'grep "{data_hoje}" | '
                f'grep -Ev "query|SQLCODE so far is 0|spill|CloseOfDRDAConnectionDetected|SQLCARD|history|ODBC|INFO|DEBUG|COMMUNICATION|ignored|denied|AbortCommunicationException|reset|VECTOR|E4039|Update|GetVersionInformation"; '
            )
